...
- Or use the managed Cloud9 tier—convenience without lock-in
...
The consensus layer is isolated from storage, enabling operational features like dynamic leader placement, witness replicas, and future consensus innovations without rewriting the database core. All queries—SQL, KV, graph, vector—lower into a common Transactional IR (TxIR), making new APIs straightforward to add. SDKs in TypeScript, Python, Go, and Rust provide unified transaction semantics across languages. Open-core model: MIT-licensed engine, with the managed Cloud9 tier handling managed orchestration, time coordination, and global operations.
...
```bash
# Clone and build
git clone https://github.com/sujiththota/cloud9
cd cloud9
cargo build --release
...
- **Issues**: [GitHub Issues](https://github.com/sujiththota/cloud9/issues) for bug reports and feature requests
- **Discussions**: [GitHub Discussions](https://github.com/sujiththota/cloud9/discussions) for questions and ideas
