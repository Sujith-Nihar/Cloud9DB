...
**Future enhancement**: TrueTime-like with GPS/atomic clocks for the managed Cloud9 tier premium offering (colocated deployments).
...
**Target**: Ship with PTP/PHC support on Nitro as default; offer Outposts/colo as premium tier for the managed Cloud9 tier.
...
- Managed Cloud9 tier offering for convenience, not lock-in
- Community can fork if sujith thota disappears
